...
import styles from "./vehicle-preview.module.css";

export const metadata: Metadata = {
  title: "The Orbiter Preview | Ascerex",
  description:
    "An alternate presentation of the Ascerex Orbiter atmospheric vehicle program.",
  robots: {
    index: false,
    follow: false,
  },
